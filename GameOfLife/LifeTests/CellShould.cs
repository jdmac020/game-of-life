...
public class CellShould
{
	...
	[Fact]
	public void SurviveWithThreeAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (true, -1,-1),
	...
	[Fact]
	public void DieWithFourAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (true, -1,-1),
	...
	[Fact]
	public void DieWithOneAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (false, -1,-1),
	...
	[Fact]
	public void DieWithAllAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (true, -1,-1),
	...
	[Fact]
	public void StayDeadWithTwoAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (true, -1,-1),
	...
	[Fact]
	public void StayDeadWithFourAliveNeighbors()
	{
		var biomeCells = new List<Cell>
		{
			new (true, -1,-1),
